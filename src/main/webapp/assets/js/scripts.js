...
// CHOOSE DISPLAY COLUMNS
  ...
  $("table.responsive-userchoice").addClass("enhanced");
  var container = $('<div class="table-menu table-menu-hidden"><ul /></div>');
  $( "table.responsive-userchoice thead th" ).each(function(i){
     var th = $(this),
        id = th.attr("id"),
     ...
     $( "table.responsive-userchoice tbody tr" ).each(function(){
   ...
   var menuWrapper = $('<div class="table-menu-wrapper" />'),
      menuBtn = $('<a href="#" class="decorate table-menu-btn">Display Additional Information</a>');
   ...
   $("ul.action-menu").before(menuWrapper);  // append the menu immediately before the action-menu before the table
