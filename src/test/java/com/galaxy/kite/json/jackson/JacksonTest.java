...
public class JacksonTest {
	...
	public void testConverObjectToJson() throws JsonGenerationException, JsonMappingException, IOException{
		...
		System.out.println(String.format("Google lib:Object:", Objects.toStringHelper(kite)));
		System.out.println(String.format("Convert person to pretty json %s", ObjectFormat.toJsonString(kite, true)));
	}
